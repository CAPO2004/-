...
class FormManager {
    ...
    async handleSubmit(e) {
        ...
        try {
            ...
            // تحويل FormData إلى URLSearchParams للإرسال
            ...
            if (result.status === 'success') {
                this.showMessage("success", "تم الإرسال بنجاح!", "شكراً لك على مشاركتك في الاستطلاع. تم حفظ إجاباتك بنجاح.");
                this.form.reset();
                this.clearDraft();
            ...
            this.showMessage("error", "خطأ في الإرسال", "حدث خطأ أثناء إرسال البيانات. يرجى المحاولة مرة أخرى.");
        } finally {
